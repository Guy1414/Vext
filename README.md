...
While: 2
Deep chain: 121
sum: 52, result: 9.56636, concat: Hello, World! auto text 52 4.78318!
complexBool: 0, testNegation: 0
val: 12, calc: 40, message: Hello, Vext!
complexCalc: 14, nestedFold: 40
logicTest: 0, mod: 1, exp: 1000
angle: 0.5, trigTest: 0.719181902813473, hypot: 5
finalCalc: -5, mixed: Result: -5, Bool: 0, Msg: Hello, Tester!
empty: '', zero: 0, negative: -42, negativeFloat: -3.14
falseVal: 0, trueVal: 0, specialChars: !@#$%^&*()_+-=[]{}|;:'\",.<>/?
...
STORE_VAR            │ 44
─────────────────────────────────────────────────────
JMP_IF_VAR_OP_CONST  │ (44, <, 100000, 258)
─────────────────────────────────────────────────────
INC_VAR              │ 44
─────────────────────────────────────────────────────
JMP                  │ 255
